...
"""
Provide an API for populating the "cpuidle" data tab of the "SysInfo" container tab.
"""
...
class CPUIdleDTabBuilder(_SysInfoDTabBuilderBase.SysInfoDTabBuilderBase):
    ...
    def __init__(self, outdir: Path, stats_paths: dict[str, Path], basedir: Path | None = None):
        ...
        super().__init__("cpuidle", outdir, _FILE_PREVIEWS, stats_paths, basedir=basedir)
