...
"""
Provide an API for populating the "x86_energy_perf_policy" data tab in the "SysInfo" container tab.
"""
...
class EPPDTabBuilder(_SysInfoDTabBuilderBase.SysInfoDTabBuilderBase):
    """
    Provide an API for populating the "x86_energy_perf_policy" data tab in the "SysInfo" container
    tab.
    """
