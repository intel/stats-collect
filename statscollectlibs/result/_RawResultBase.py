...
class RawResultInfoTypedDict(TypedDict, total=False):
    ...
    Attributes:
        ...
        cpus: A list of CPU numbers that were measured when running the test that generated by the
              raw test result. None if not specific CPU numbers were targeted.
