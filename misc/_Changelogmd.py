...
def get_chmd_entries(path):
    ...
    with open(path, "r", encoding="utf-8") as fobj:
        ...
        #  - Add a feature
        #
        # So the idea is that we match the 'start_line', which is '## [1.3.21] - 2022-09-29' in
        # this example. We include all lines until we meet 'stopline', which is '## [1.3.20] -
        # 2022-09-21' in this example (or the end of file). We do not include the 'stopline' to
        # the changelog entry, it is actually the beginning of the next changelog entry.
        #
